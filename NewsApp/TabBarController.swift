...
final class TabBarController: UITabBarController {
    ...
    private func setupViewControllers() {
        ...
        viewControllers = [
            ...
            setupNavigationControllers(rootViewController: TechnologyViewController(viewModel: TechnologyViewModel()), title: "Technology", image: UIImage(systemName: "gyroscope") ?? UIImage.add)
        ]
    }
